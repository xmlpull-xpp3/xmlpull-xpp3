...
/**
 * This is simple class that implemnnts parser interface by delegating
 * all calls to actual partser implementation passed in constructor.
 * Purpose of this class is to work as base class when dynamically extending parser interface
 * by wrapping exsiting parser implementation.
 *
